...
#### `strip([chars: str])`
Удаляет начальные и конечные пробелы в строке, либо символы `chars` . Применяется два алгоритма: либо по совпадению последовательности символов, либо по перечню символов и/или совпадений
